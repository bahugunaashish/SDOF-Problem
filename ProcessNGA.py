...
@author: Ashish Bahuguna
    ...
    This code is modification of code developed by Daniel Hutabarat - 
                                                   UC Berkeley, 2017
...
def processNGAfile(filepath, scalefactor=None):
    ...
    try:
        ...
        print(f'{desc} Number of points = {npts} \ndt = {dt}')
        plt.plot(time, inp_acc, color = 'blue', linewidth = 1., label= desc[0:11] ) #color = 'blue'
        plt.xlabel("Time (s)")

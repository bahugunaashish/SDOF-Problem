...
This code contains a function based on Newmark-Beta Method for solving 
the Equation of motion in form of 
                
                m*a + c*v + k*u = -m*ug
                
                where m is mass ; a acceleration ; c is damping; v is velocity; 
                k is stiffness; u is displacement of the system
                ug is input motion 
